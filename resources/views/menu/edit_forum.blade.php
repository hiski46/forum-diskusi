        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="/edit-forum/{{ $forum->id }}" method="POST" enctype="multipart/form-data"
                        onsubmit="showLoader()">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" name="old_file" value="{{ $forum->file }}">
                                @if ($forum->file)
                                    <a class="no-load" href="{{ asset('storage/file_forum/' . $forum->file) }}"
                                        target="_blank">{{ $forum->file }}</a>
                                @endif
                                <div class="input-group input-group-merge">
